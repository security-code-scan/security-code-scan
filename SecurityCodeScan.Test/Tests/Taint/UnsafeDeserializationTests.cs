    ...
    public class UnsafeDeserializationTests : DiagnosticVerifier
    {
        protected override IEnumerable<DiagnosticAnalyzer> GetDiagnosticAnalyzers(string language)
        {
            if (language == LanguageNames.CSharp)
                return new DiagnosticAnalyzer[] { new CSharpAnalyzers(new DeserializationTaintAnalyzer()) };
            else
                return new DiagnosticAnalyzer[] { new VBasicAnalyzers(new DeserializationTaintAnalyzer()) };
        }
