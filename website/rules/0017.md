### SG0017 - Request Validation Disabled (Attribute)
Request validation is disabled. Request validation allows the filtering of some [XSS](#SG0029) patterns submitted to the application.
#### Risk
[XSS](#SG0029)
#### Vulnerable Code
```cs
